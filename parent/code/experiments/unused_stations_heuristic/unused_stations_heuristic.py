...
if __name__ == "__main__":
    ...
    ## 2. Random_Greedy with and without original starting stations
    ...
    # Calculate average scores
    print(f"Average score for Random_Greedy with original starting stations ({iterations} iterations): {np.mean(results_randomv2_with_original_stations)}")
    print(f"Average score for Random_Greedy without original starting stations ({iterations} iterations): {np.mean(results_randomv2_without_original_stations)}")
